...
var (
	...
	ErrorGetArticle    = NewError(20010006, "获取文章失败")
	ErrorCreateArticle = NewError(20010007, "创建文章失败")
	ErrorUpdateArticle = NewError(20010008, "更新文章失败")
	ErrorDeleteArticle = NewError(20010009, "删除文章失败")
